...
def alf_1st(base_layers, num_anchors, filters=256, kersize=(3, 3), trainable=True):
    ...
    P3_cls, P3_regr = alf_pred(P3, num_anchors[0], name='pred0_1', filters=filters, kersize=kersize,
                               trainable=trainable)
    P4_cls, P4_regr = alf_pred(base_layers[1], num_anchors[1], name='pred1_1', filters=filters, kersize=kersize,
                               trainable=trainable)
    P5_cls, P5_regr = alf_pred(base_layers[2], num_anchors[2], name='pred2_1', filters=filters, kersize=kersize,
                               trainable=trainable)
    P6_cls, P6_regr = alf_pred(P6, num_anchors[3], name='pred3_1', filters=filters, kersize=kersize,
                               trainable=trainable)
...
def alf_2nd(P3, P4, P5, P6, num_anchors, filters=256, kersize=(3, 3), trainable=True):
    P3_cls, P3_regr = alf_pred(P3, num_anchors[0], name='pred0_2', filters=filters, kersize=kersize,
                               trainable=trainable)
    P4_cls, P4_regr = alf_pred(P4, num_anchors[1], name='pred1_2', filters=filters, kersize=kersize,
                               trainable=trainable)
    P5_cls, P5_regr = alf_pred(P5, num_anchors[2], name='pred2_2', filters=filters, kersize=kersize,
                               trainable=trainable)
    P6_cls, P6_regr = alf_pred(P6, num_anchors[3], name='pred3_2', filters=filters, kersize=kersize,
                               trainable=trainable)
...
def alf_3rd(P3, P4, P5, P6, num_anchors, filters=256, kersize=(3, 3), trainable=True):
    P3_cls, P3_regr = alf_pred(P3, num_anchors[0], name='pred0_3', filters=filters, kersize=kersize,
                               trainable=trainable)
    P4_cls, P4_regr = alf_pred(P4, num_anchors[1], name='pred1_3', filters=filters, kersize=kersize,
                               trainable=trainable)
    P5_cls, P5_regr = alf_pred(P5, num_anchors[2], name='pred2_3', filters=filters, kersize=kersize,
                               trainable=trainable)
    P6_cls, P6_regr = alf_pred(P6, num_anchors[3], name='pred3_3', filters=filters, kersize=kersize,
                               trainable=trainable)
